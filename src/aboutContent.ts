...
export const ABOUT_SECTIONS = [
  ...
  },
  {
    heading: 'Privacy',
    body:
      'Resusci-Time runs entirely in your browser. It does not send patient data to a server. Event logs are saved automatically on this device as you work (Saved logs) and can be exported as CSV or PDF. Theme preference may persist in browser storage.',
  },
  {
