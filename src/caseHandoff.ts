...
export const CASE_HANDOFF_PRIVACY_NOTE =
  'The QR code contains the full active case (log and timer state). Nothing is stored on a server. Scan on the device that should take over. After transfer, confirm on the sending device with Case transferred — do not add entries on both devices.'
